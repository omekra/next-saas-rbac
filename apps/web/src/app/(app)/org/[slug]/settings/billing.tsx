          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.projects.price.toLocaleString('en-AU', {
                    style: 'currency',
                    currency: 'AUD',
                  })}{' '}
                  (
                  {billing.projects.unit.toLocaleString('en-AU', {
                    style: 'currency',
                    currency: 'AUD',
                  })}{' '}
                  each)
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.seats.price.toLocaleString('en-AU', {
                    style: 'currency',
                    currency: 'AUD',
                  })}{' '}
                  (
                  {billing.seats.unit.toLocaleString('en-AU', {
                    style: 'currency',
                    currency: 'AUD',
                  })}{' '}
                  each)
            ...
            <TableFooter>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {billing.total.toLocaleString('en-AU', {
                    style: 'currency',
                    currency: 'AUD',
                  })}
                </TableCell>
